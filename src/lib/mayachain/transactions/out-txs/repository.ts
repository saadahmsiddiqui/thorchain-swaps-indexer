...
export async function storeTransactionOutTx(
    ...
    const query = `INSERT INTO mayachain.out_txs (${cols}) VALUES ($1,$2,$3,$4,$5,$6) RETURNING id`;
...
export async function getTransactionOutTxs(
    ...
    const query = `SELECT * FROM mayachain.out_txs WHERE tx_base_info_id = $1`;
