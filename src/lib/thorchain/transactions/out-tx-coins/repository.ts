...
export async function storeTransactionOutTxCoin(
    ...
    const query = `INSERT INTO thorchain.out_tx_coins (${cols}) VALUES ($1,$2,$3,$4)`;
...
export async function getTransactionOutTxCoins(
    ...
    const query = `SELECT * FROM thorchain.out_tx_coins WHERE out_tx_id = $1 AND coin_type = $2`;
...
export async function updateTransactionOutTxCoin(
    ...
    const query = `
    UPDATE thorchain.out_tx_coins SET
      coin_type = $2,
      asset = $3,
      amount = $4
