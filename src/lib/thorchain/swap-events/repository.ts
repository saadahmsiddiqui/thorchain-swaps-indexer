...
export async function store(
    ...
    const cols = `height, id, chain, coin, emit_asset, from_address, to_address, memo, mode, pool, liquidity_fee, liquidity_fee_in_native_currency, pool_slip, swap_slip, swap_target, streaming_swap_count, streaming_swap_quantity`;
